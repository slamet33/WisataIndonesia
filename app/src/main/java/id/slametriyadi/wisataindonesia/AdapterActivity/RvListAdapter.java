...
public class RvListAdapter extends RecyclerView.Adapter<RvListAdapter.MyViewHolder> {
    ...
    public RvListAdapter(RecyclerView recyclerView, Context context, List<ListDataDaerah> dataItems) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                context.startActivity(new Intent(context, ProvinsiSecondActivity.class)
                        .putExtra("gambar", dataItems.get(position).getImageDaerah())
                        .putExtra("nama", dataItems.get(position).getNamaDaerah())
                        .putExtra("idDaerah", dataItems.get(position).getIdDaerah())
                );
            }
        });
    }
